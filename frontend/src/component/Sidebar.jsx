...
export const SidebarCompnent = ({ open, onClose }) => {
    ...
    const drawerItems = [
        ...
        { text: 'About', icon: < InfoIcon className=' text-gray-400'/>, path: '#about' },
    ];
    ...
    return (
        <div className=''>
            ...
            <Drawer
                ...
                sx={{
                    display: { xs: 'block', sm: 'block', md: 'none', xl: 'none', xxl: 'none' },
            ...
            >
                <div className="bg-gray-700 p-8 h-full text-white">
                    <div className=' flex justify-between'>
                        ...
                        <motion.span
                            initial={{ scale: 0.5 }}
                            animate={{ scale: 1 }} whileTap={{ scale: 0.5 }} transition={{ duration: 2, delay: 3 }}>
                    ...
                    <ul className="mt-6 space-y-1">
                        {drawerItems.map((item, i) => (
                            <a key={i} href={item.path} className="block w-full" onClick={onClose}>
                                <motion.li
