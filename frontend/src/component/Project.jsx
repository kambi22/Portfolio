...
import { FaCode, FaGithub, FaLinkedin, FaNodeJs, FaReact, FaVoicemail } from "react-icons/fa6";
    ...
    <div id="projects" className=" h-full mt-30 pb-40    w-full m-auto">
      <Container >
        <div className="flex justify-center mb-20 ">
          ...
          <h1 className="font-bold p-2 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">My</h1>
          <h1 className="font-bold ms-2 text-white mt-2" data-aos='fade-down'>Projects</h1>
        </div>
        {isXlScreen ? (
          <Carousel
          ...
          <div className="" data-aos='slide-up'>
                <div   key={i} className="m-5 mb-10 text-start cursor-pointer gap-5 rounded-2xl transition-all ease-out duration-300 hover:-translate-y-5 shadow-lg hover:shadow-blue-500/50">
                ...
                <div className="text-white p-3">
                  ...
                  <div className="flex gap-3">
                    <a href={item.live} target="_blank" rel="noopener noreferrer"
                     className="outline-2 outline-cyan-500 rounded-2xl ps-5 pe-5 pt-2 pb-2 shadow-sm hover:shadow-blue-500 flex"><RiExternalLinkFill className="mt-1 me-1" />Live</a>
                    <a href={item.code} target="_blank" rel="noopener noreferrer"
                     className="outline-2 outline-purple-500 rounded-2xl ps-5 pe-5 pt-2 pb-2 shadow-sm hover:shadow-blue-500 flex"><FaCode className="mt-1 me-1"/>Code</a>
          ...
          <Carousel
           ...
           {projects.map((item, i) => (
             <div className="" data-aos='slide-up'>
              <div key={i} className="m-3  text-start cursor-pointer gap-5 rounded-2xl transition-all ease-out duration-300 hover:-translate-y-5 shadow-lg hover:shadow-blue-500/50">
                <img className="rounded-2xl h-60" src={item.image } alt="" />
                <div className="text-white p-3">
                  <h5 className="text-2xl ">{item.title}</h5>
                  <p className="text-gray-100">{item.description}</p>
          ...
          {projects.map((item, i) => (
             <div className="" data-aos='slide-up'>
              <div  key={i} className=" mb-20 text-start cursor-pointer gap-5 rounded-2xl transition-all ease-out duration-300 hover:-translate-y-5 shadow-lg hover:shadow-blue-500/50">
                <img className="rounded-2xl h-60" src={item.image } alt="" />
                <div className="text-white p-3">
                  <h5 className="text-2xl ">{item.title}</h5>
                  <p className="text-gray-100">{item.description}</p>
...
<a href="#hero">
        <FaHandPointUp  className="ms-auto me-5 animate-bounce transition-all duration:200 ease-inout" color="white" size={60}/>
