    ...
    <div id="about" className=" h-full mt-40  m-auto" >
      <Container className="">
        ...
        <p className="text-white text-2xl mt-3 bg-gra">
         Full-stack developer specializing in MERN stack development, with expertise in building efficient, scalable, and high-performance web solutions.
         </p>
         </div>
        <Grid  container sx={{ marginTop: '70px' }} spacing={3}>
          <Grid item size={{ xl: 6, md: 6, sm: 12, xs: 12 }} className=""  data-aos='fade-right'>
            <motion.div
            ...
            <span className="absolute inset-0 pointer-events-none z-0 animate-shimmer opacity-0 group-hover:opacity-60 transition-opacity duration-300" />
              ...
              <h5 className="text-white text-2xl sm:text-4xl ">Bachelor Of Computer Application</h5>
              <h3 className="text-white ">Baba Mangal Singh College MRSPTU Bathinda</h3>
              <p className="text-cyan-200">Year: 2021-2024</p>
            </motion.div>
          </Grid>
          <Grid item size={{ xl: 6, md: 6, sm: 12, xs: 12 }} className="" data-aos='fade-left'>
            <motion.div
            ...
            <span className="absolute inset-0 pointer-events-none z-0 animate-shimmer opacity-0 group-hover:opacity-60 transition-opacity duration-300" />
              ...
              <h5 className="text-white text-2xl sm:text-4xl mt-3">Non-medical</h5>
              <h5 className="text-white text-2xl sm:text-4xl ">Science Stream</h5>
              <h3 className="text-white mt-4">Smart School, Bheem Nagar(Moga)</h3>
              <p className="text-cyan-200 mt-4">Year: 2019-2021</p>
            </motion.div>
          </Grid>
